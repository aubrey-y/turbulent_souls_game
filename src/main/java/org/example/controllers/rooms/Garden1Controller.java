...
public class Garden1Controller extends GameScreenController implements Initializable {
    ...
    public Garden1Controller(AppService appService, PlayerService playerService, DirectionService directionService, RoomDirectionService roomDirectionService, HealthService healthService, Scene scene) {
