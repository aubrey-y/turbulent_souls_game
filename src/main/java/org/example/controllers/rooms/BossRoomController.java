...
public class BossRoomController extends GameScreenController implements Initializable {
    ...
    public BossRoomController(AppService appService, PlayerService playerService, DirectionService directionService, RoomDirectionService roomDirectionService, HealthService healthService, Scene scene) {
