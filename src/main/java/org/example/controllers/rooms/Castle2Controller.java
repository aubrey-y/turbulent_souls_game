...
public class Castle2Controller extends GameScreenController implements Initializable {
    ...
    public Castle2Controller(AppService appService, PlayerService playerService, DirectionService directionService, RoomDirectionService roomDirectionService, HealthService healthService, Scene scene) {
