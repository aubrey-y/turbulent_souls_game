...
public class GardenTraderController extends GameScreenController implements Initializable {
    ...
    public GardenTraderController(AppService appService, PlayerService playerService, DirectionService directionService, RoomDirectionService roomDirectionService, HealthService healthService, Scene scene) {
