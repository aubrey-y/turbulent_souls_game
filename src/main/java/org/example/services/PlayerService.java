...
public class PlayerService {
    ...
    public static final double MOVE_SIZE = 50;
    ...
    public void moveUp(boolean shift) {
        this.imageView.setTranslateY(
                this.imageView.getTranslateY() - (!shift ? MOVE_SIZE : MOVE_SIZE * 5));
        this.checkForExit();
    }
    ...
    public void moveRight(boolean shift) {
        this.imageView.setTranslateX(
                this.imageView.getTranslateX() + (!shift ? MOVE_SIZE : MOVE_SIZE * 5));
        this.checkForExit();
    }
